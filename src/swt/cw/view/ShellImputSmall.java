...
public class ShellImputSmall extends Dialog{
	...
	public ShellImputSmall(Shell parent) {
		super(parent);
		createShell();
		inicialize();
	}
	...
	private void createShell() {
		...
		buttonOk.setImage(SWTResourceManager.getImage(ShellImputSmall.class, "/rdw/icon/icon_accept.png"));
		buttonOk.setText("Ok");
