...
import swt.cw.view.ShellF12Message;
import swt.cw.view.ShellImputSmall;
import swt.cw.view.ShellInput;
import swt.cw.view.ShellMessage;
import swt.cw.view.ShellQuestion;
...
public class Dialog {
	...
	public static String input(Shell parent,String title,String message){
		...
		ShellImputSmall input = new ShellImputSmall(parent);
		input.setText(title);
